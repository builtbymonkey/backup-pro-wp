...
<tr>
    ...
    <td>
        ...
        <?php echo $this->backup_lib->displayFormErrors($form_errors['s3_access_key']); ?>
    </td>
</tr>
<tr>
    <th scope="row">
    ...
    <td>
        ...
        <?php echo $this->backup_lib->displayFormErrors($form_errors['s3_secret_key']); ?>
    </td>
</tr>
<tr>
    <th scope="row">
    ...
    <td>
        ...
        <?php echo $this->backup_lib->displayFormErrors($form_errors['s3_bucket']); ?>
    </td>
</tr>
<tr>
    <th scope="row">
    ...
    <td>
        ...
        <?php echo $this->backup_lib->displayFormErrors($form_errors['s3_optional_prefix']); ?>
    </td>
</tr>
<tr>
    <th scope="row">
    ...
    <td>
        ...
        <?php echo $this->backup_lib->displayFormErrors($form_errors['s3_reduced_redundancy']); ?>
    </td>
</tr>
