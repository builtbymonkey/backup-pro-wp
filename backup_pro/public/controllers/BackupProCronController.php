 ...
 * @version		3.0
 * @filesource 	./backup_pro/admin/controllers/BackupProCronController.php
 */
...
/**
 * Backup Pro - Wordpress Cron Controller
 *
 * Contains the Cron Controller Actions for Wordpress
 *
 * @package 	BackupPro\Wordpress\Controllers
 * @author		Eric Lamb <eric@mithra62.com>
 */
class BackupProCronController extends WpController implements BpInterface
{
